defmodule BookshelfWeb.CoreComponents do
  ...
  ###
  ### From there starts custom components
  ###

  use Phoenix.VerifiedRoutes, endpoint: BookshelfWeb.Endpoint, router: BookshelfWeb.Router

  attr :current_page, :integer, required: true
  def pagination(assigns) do
    ~H"""
      <div class="inline-flex items-center justify-center gap-3 mt-5 hover:cursor-pointer">
      <div
        phx-click="decr_page"
      ...
      <div
        phx-click="incr_page"
        class="inline-flex size-8 items-center justify-center rounded border border-gray-100 bg-white text-gray-900 rtl:rotate-180 hover:cursor-pointer"
      >
        <span class="sr-only">Next Page</span>
        <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" viewBox="0 0 20 20" fill="currentColor">
          <path
      ...
      <article class="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm" :for={book <- @books}>
        ...
        <.modal id={"modal-#{book.id}"}>
          <div class="flex flex-row items-start mb-4">
            <img class="basis-1/4 shrink mr-4 max-w-72" src={"data:#{book.cover_type};base64, #{book.cover}"} alt={"#{book.title} cover"} />
          ...
          <div class="flex gap-4 mb-5">
            ...
            <.link href={~p"/books/#{book.id}"} method="delete">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
